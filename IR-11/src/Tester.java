...
public class Tester {
    ...
    public static void getInfo(FictionBook fb2) {
        ...
        try {
            ...
            //publish info
            System.out.println("Book Name: " + fb2.getDescription().getPubishInfo().getBookName());
            System.out.println("City: " + fb2.getDescription().getPubishInfo().getCity());
            System.out.println("Publisher: " + fb2.getDescription().getPubishInfo().getPublisher());
            System.out.println("Year: " + fb2.getDescription().getPubishInfo().getYear());
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
